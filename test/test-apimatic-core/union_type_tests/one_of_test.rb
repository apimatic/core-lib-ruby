...
class OneOfTest < Minitest::Test
        ...
        LeafType.new(DateTime,
                     UnionTypeContext.new(
                       date_time_converter: proc do |dt_string|
                         DateTimeHelper.to_unix(dt_string)
                       end,
  ...
  def test_exception_message_evening_outer_array_type_one_of
    _one_of = OneOf.new([
                          LeafType.new(Morning, UnionTypeContext.new(is_array: true)),
                          LeafType.new(Evening)
                        ], UnionTypeContext.new(is_array: true)
...
Actual Value: [{"startsAt":"8:00","endsAt":"10:00","offerTeaBreak":true,"sessionType":"Evening"},{"startsAt":"8:00","endsAt":"10:00","offerDinner":true,"sessionType":"Evening"},{"startsAt":"8:00","endsAt":"10:00","offerDinner":true,"sessionType":"Evening"}]
Expected Type: One Of TestComponent::Morning, TestComponent::Evening.'
